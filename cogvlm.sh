...
# Evaluation
python eval_script/DVQA_eval.py --path evaluation_results/DVQA/dvqa_CogVLM.jsonl
python eval_script/TallyQA_eval.py --path evaluation_results/TallyQA/TallyQA_CogVLM.jsonl
python eval_script/TDIUC_eval.py --path evaluation_results/TDIUC/TDIUC_CogVLM.jsonl
python eval_script/VQDv1_eval.py --path evaluation_results/VQDv1/VQDv1_CogVLM.jsonl