...
class BaseDatasetBuilder:
    ...
    def build_datasets(self):
        ...
        if is_main_process():
            # print("base_dataset_builder.py: 48")
            self._download_data()
        ...
        print("Built {} datasets".format(len(datasets)))
            ...
            for url_or_filename, storage_path in zip(urls, storage_paths):
                ...
                if os.path.isfile(url_or_filename):
                    ...
                    if not os.path.exists(dst):
                        ...
                        # print("Using existing file {}.".format(dst))
                        shutil.copyfile(src=src, dst=dst)
                        logging.info("Using existing file {}.".format(dst))
                else:
                    # print("it is not a file:{}".format(url_or_filename))
    ...
    def build(self):
        ...
        for split in ann_info.keys():
            ...
            if vis_processor is None:
                print(f"{split}: vis_processor None")
            text_processor = (
            ...
            if text_processor is None:
                print(f"{split}: text_processor None")
